...
const linkmap = { // for urls and images for each search type
    ...
    itemdb: {
        ...
        "img": "https://itemdb.com.br/_next/static/media/logo_white_compressed.a0bfe8ab.svg"
    }
...
function makelinks(item, extras) {
    ...
    // ItemDB
    links += `<a tabindex='-1' target='_blank' href='${linkmap.itemdb.url.replace("%s", name)}'><img src='${linkmap.itemdb.img}' class='itemdbimg'></a>`;
